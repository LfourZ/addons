...
E2Helper.Descriptions["runOnVehicleEnter"] = 			"If set to 1, chip will run on someone entering a vehicle."
E2Helper.Descriptions["runOnVehicleLeave"] = 			"If set to 1, chip will run on someone leaving a vehicle."